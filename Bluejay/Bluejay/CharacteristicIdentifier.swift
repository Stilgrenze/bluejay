...
public struct CharacteristicIdentifier {
    ...
    public init(_ cbCharacteristic: CBCharacteristic) {
        self.service = ServiceIdentifier(uuid: cbCharacteristic.service?.uuid ?? CBUUID(string: "00000000-0000-0000-000000000000"))
    ...
    public static func == (lhs: CharacteristicIdentifier, rhs: CBCharacteristic) -> Bool {
        return (lhs.uuid == rhs.uuid) && (lhs.service.uuid == rhs.service?.uuid ?? CBUUID(string: "00000000-0000-0000-000000000000"))
    }
}
